...
* Table.java
*
* This file has been given as a template, and the only things that have been
* changed are:
*    1. Three extra instance variables to track the collisions
*    2. The put method, as it has been changed to count the collisions 
*    3. Added the getters, getCollions, getTotalCollisions, and getAverageCollisions
...
public class Table< K , E >
{
   ...
   //   5. The collisions instance variable is used to determine
   //      the number of collisions that occured while putting the elements into the 
   //      table to determine the table's analysis.
   ...
   **/
   ...
   /**
   * Determines if a specified key, and will return the value of the 
   * key's index for the specified key.
   * @param <CODE>key</CODE>
   *   the non-null key to look for
   * <dt><b>Precondition:</b><dd>
   *   <CODE>key</CODE> cannot be null.
   ...
   **/
   ...
   /** 
   * Determines and returns the calculated index of the element 
   * using the hash code.
   * @param <CODE>key</CODE>
   *   the non-null key to look for
   * <dt><b>Precondition:</b><dd>
   ...
   **/
   ...
   /** 
   * Determines and returns the next available index of the element.
   * @param <CODE>i</CODE>
   *   the index we are working with
   * <dt><b>Precondition:</b><dd>
   *   <CODE>i</CODE> cannot be null.
   * @return
   ...
   **/
   ...
   /**
   * Gets the collisions per placed element
   * <dt><b>Param- none:</b><dd>
   * <dt><b>Postcondition:</b><dd>
   *   The collisions per element has been returned. 
   **/ 
   ...
   * <dt><b>Param- none:</b><dd>
   * <dt><b>Postcondition:</b><dd>
   *   The instance variable manyItems has been returned. 
   **/
   ...
   public E put(K key, E element) {
      ...
      if (index != -1) {  // The key is already in the table.
         ...
         while (keys[index] != null) {
            ...
            collisions++;                 //will determine the amount of collisions the elements encountered while being added
         }
         keys[index] = key;
         data[index] = element;
