...
* TableDoubleHash.java
*
* This file is similar to the Table.java file, the main difference is in the put
* method, which if an element experiences a collision, rather than moving to the 
* next index, which would be i+1, it will complete another hash to find the next index. 
*****************************************************************************************/
public class TableDoubleHash < K , E > {
   ...
   //   5. The collisions instance variables is used to determine
